...
shotgun_phyloseq <- readRDS("../../../input_raw//atlas_binning_phyloseq.rds")
meta_all<-read.csv("../../../input_raw/meta_PRJDB4176.tsv",sep = ",") %>% data.frame() %>% dplyr::select(Run,Age,sex,host_disease_stat)
...
project_name="PRJDB4176_binning_"
### classfy
