...
shotgun_phyloseq <- readRDS("../../../Analysis_shotgun_PRJDB4176/input_raw/atlas_binning_phyloseq.rds")
meta_all<-read.csv("../../../Analysis_shotgun_PRJDB4176/input_raw/meta_PRJDB4176.tsv",sep = ",") %>% data.frame() %>% dplyr::select(Run,Age,sex,host_disease_stat)
